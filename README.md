...
be constructed programmatically by create trees of descriptor protos and using the `desc` package
to link those into rich descriptors. But constructing a valid tree of descriptor protos is not a
trivial task.
