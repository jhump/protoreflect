...
func (r *parseResult) asUninterpretedOptions(nodes []*ast.OptionNode) []*descriptorpb.UninterpretedOption {
	if len(nodes) == 0 {
		return nil
	}
...
func (r *parseResult) asUninterpretedOption(node *ast.OptionNode) *descriptorpb.UninterpretedOption {
...
func (r *parseResult) asUninterpretedOptionName(parts []*ast.FieldReferenceNode) []*descriptorpb.UninterpretedOption_NamePart {
...
func (r *parseResult) addExtensions(ext *ast.ExtendNode, flds *[]*descriptorpb.FieldDescriptorProto, msgs *[]*descriptorpb.DescriptorProto, isProto3 bool) {
...
func (r *parseResult) asFieldDescriptor(node *ast.FieldNode, maxTag int32, isProto3 bool) *descriptorpb.FieldDescriptorProto {
	tag := node.Tag.Val
...
func (r *parseResult) asGroupDescriptors(group *ast.GroupNode, isProto3 bool, maxTag int32) (*descriptorpb.FieldDescriptorProto, *descriptorpb.DescriptorProto) {
	tag := group.Tag.Val
...
func (r *parseResult) asMapDescriptors(mapField *ast.MapFieldNode, isProto3 bool, maxTag int32) (*descriptorpb.FieldDescriptorProto, *descriptorpb.DescriptorProto) {
...
func (r *parseResult) asExtensionRanges(node *ast.ExtensionRangeNode, maxTag int32) []*descriptorpb.DescriptorProto_ExtensionRange {
...
func (r *parseResult) asEnumValue(ev *ast.EnumValueNode) *descriptorpb.EnumValueDescriptorProto {
...
func (r *parseResult) asMethodDescriptor(node *ast.RPCNode) *descriptorpb.MethodDescriptorProto {
...
func (r *parseResult) asEnumDescriptor(en *ast.EnumNode) *descriptorpb.EnumDescriptorProto {
...
func (r *parseResult) asEnumReservedRange(rng *ast.RangeNode) *descriptorpb.EnumDescriptorProto_EnumReservedRange {
...
func (r *parseResult) asMessageDescriptor(node *ast.MessageNode, isProto3 bool) *descriptorpb.DescriptorProto {
...
func (r *parseResult) addMessageBody(msgd *descriptorpb.DescriptorProto, body *ast.MessageBody, isProto3 bool) {
...
func (r *parseResult) asMessageReservedRange(rng *ast.RangeNode, maxTag int32) *descriptorpb.DescriptorProto_ReservedRange {
	start, end := getRangeBounds(r, rng, 0, maxTag)
...
func (r *parseResult) asServiceDescriptor(svc *ast.ServiceNode) *descriptorpb.ServiceDescriptorProto {
