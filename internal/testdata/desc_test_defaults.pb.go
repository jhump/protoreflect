...
var file_desc_test_defaults_proto_rawDesc = []byte{
	...
	0x07, 0x0a, 0x03, 0x44, 0x4f, 0x53, 0x10, 0x02, 0x1a, 0x02, 0x10, 0x01, 0x42, 0x34, 0x5a, 0x32,
...
func file_desc_test_defaults_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_desc_test_defaults_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_desc_test_defaults_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_desc_test_defaults_proto_msgTypes[2].Exporter = func(v any, i int) any {
		...
		file_desc_test_defaults_proto_msgTypes[3].Exporter = func(v any, i int) any {
