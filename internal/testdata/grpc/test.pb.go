...
var file_grpc_test_proto_rawDesc = []byte{
	...
	0x2e, 0x4c, 0x6f, 0x61, 0x64, 0x42, 0x61, 0x6c, 0x61, 0x6e, 0x63, 0x65, 0x72, 0x53, 0x74, 0x61,
	0x74, 0x73, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00, 0x42, 0x39, 0x5a, 0x37,
...
func file_grpc_test_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_grpc_test_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_grpc_test_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_grpc_test_proto_msgTypes[2].Exporter = func(v any, i int) any {
		...
		file_grpc_test_proto_msgTypes[3].Exporter = func(v any, i int) any {
		...
		file_grpc_test_proto_msgTypes[4].Exporter = func(v any, i int) any {
		...
		file_grpc_test_proto_msgTypes[5].Exporter = func(v any, i int) any {
		...
		file_grpc_test_proto_msgTypes[6].Exporter = func(v any, i int) any {
		...
		file_grpc_test_proto_msgTypes[7].Exporter = func(v any, i int) any {
		...
		file_grpc_test_proto_msgTypes[8].Exporter = func(v any, i int) any {
		...
		file_grpc_test_proto_msgTypes[9].Exporter = func(v any, i int) any {
		...
		file_grpc_test_proto_msgTypes[10].Exporter = func(v any, i int) any {
