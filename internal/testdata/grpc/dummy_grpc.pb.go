...
type DummyServiceClient interface {
	...
	DoSomethingElse(ctx context.Context, opts ...grpc.CallOption) (grpc.ClientStreamingClient[testdata.TestMessage, DummyResponse], error)
	DoSomethingAgain(ctx context.Context, in *pkg.Bar, opts ...grpc.CallOption) (grpc.ServerStreamingClient[testdata.AnotherTestMessage], error)
...
func (c *dummyServiceClient) DoSomethingElse(ctx context.Context, opts ...grpc.CallOption) (grpc.ClientStreamingClient[testdata.TestMessage, DummyResponse], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &DummyService_ServiceDesc.Streams[0], DummyService_DoSomethingElse_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
	x := &grpc.GenericClientStream[testdata.TestMessage, DummyResponse]{ClientStream: stream}
	return x, nil
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type DummyService_DoSomethingElseClient = grpc.ClientStreamingClient[testdata.TestMessage, DummyResponse]

func (c *dummyServiceClient) DoSomethingAgain(ctx context.Context, in *pkg.Bar, opts ...grpc.CallOption) (grpc.ServerStreamingClient[testdata.AnotherTestMessage], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &DummyService_ServiceDesc.Streams[1], DummyService_DoSomethingAgain_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
	x := &grpc.GenericClientStream[pkg.Bar, testdata.AnotherTestMessage]{ClientStream: stream}
...
// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type DummyService_DoSomethingAgainClient = grpc.ServerStreamingClient[testdata.AnotherTestMessage]
...
type DummyServiceServer interface {
	...
	DoSomethingElse(grpc.ClientStreamingServer[testdata.TestMessage, DummyResponse]) error
	DoSomethingAgain(*pkg.Bar, grpc.ServerStreamingServer[testdata.AnotherTestMessage]) error
...
func (UnimplementedDummyServiceServer) DoSomethingElse(grpc.ClientStreamingServer[testdata.TestMessage, DummyResponse]) error {
	return status.Errorf(codes.Unimplemented, "method DoSomethingElse not implemented")
}
func (UnimplementedDummyServiceServer) DoSomethingAgain(*pkg.Bar, grpc.ServerStreamingServer[testdata.AnotherTestMessage]) error {
...
func _DummyService_DoSomethingElse_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(DummyServiceServer).DoSomethingElse(&grpc.GenericServerStream[testdata.TestMessage, DummyResponse]{ServerStream: stream})
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type DummyService_DoSomethingElseServer = grpc.ClientStreamingServer[testdata.TestMessage, DummyResponse]
...
func _DummyService_DoSomethingAgain_Handler(srv interface{}, stream grpc.ServerStream) error {
	...
	return srv.(DummyServiceServer).DoSomethingAgain(m, &grpc.GenericServerStream[pkg.Bar, testdata.AnotherTestMessage]{ServerStream: stream})
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type DummyService_DoSomethingAgainServer = grpc.ServerStreamingServer[testdata.AnotherTestMessage]
