...
func (c *dummyServiceClient) DoSomethingElse(ctx context.Context, opts ...grpc.CallOption) (DummyService_DoSomethingElseClient, error) {
	stream, err := c.cc.NewStream(ctx, &DummyService_ServiceDesc.Streams[0], DummyService_DoSomethingElse_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
...
type DummyService_DoSomethingElseClient interface {
	Send(*testdata.TestMessage) error
...
func (x *dummyServiceDoSomethingElseClient) Send(m *testdata.TestMessage) error {
...
func (c *dummyServiceClient) DoSomethingAgain(ctx context.Context, in *pkg.Bar, opts ...grpc.CallOption) (DummyService_DoSomethingAgainClient, error) {
	stream, err := c.cc.NewStream(ctx, &DummyService_ServiceDesc.Streams[1], DummyService_DoSomethingAgain_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
...
type DummyService_DoSomethingAgainClient interface {
	Recv() (*testdata.AnotherTestMessage, error)
	grpc.ClientStream
}
...
func (x *dummyServiceDoSomethingAgainClient) Recv() (*testdata.AnotherTestMessage, error) {
	m := new(testdata.AnotherTestMessage)
	if err := x.ClientStream.RecvMsg(m); err != nil {
		return nil, err
	}
	return m, nil
...
func (c *dummyServiceClient) DoSomethingForever(ctx context.Context, opts ...grpc.CallOption) (DummyService_DoSomethingForeverClient, error) {
	stream, err := c.cc.NewStream(ctx, &DummyService_ServiceDesc.Streams[2], DummyService_DoSomethingForever_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
...
type DummyService_DoSomethingElseServer interface {
	...
	Recv() (*testdata.TestMessage, error)
	grpc.ServerStream
}
...
func (x *dummyServiceDoSomethingElseServer) Recv() (*testdata.TestMessage, error) {
	m := new(testdata.TestMessage)
...
type DummyService_DoSomethingAgainServer interface {
	Send(*testdata.AnotherTestMessage) error
	grpc.ServerStream
}
...
func (x *dummyServiceDoSomethingAgainServer) Send(m *testdata.AnotherTestMessage) error {
	return x.ServerStream.SendMsg(m)
}
