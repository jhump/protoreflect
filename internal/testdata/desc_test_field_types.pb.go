...
var file_desc_test_field_types_proto_rawDesc = []byte{
	...
	0x02, 0x12, 0x09, 0x0a, 0x05, 0x54, 0x48, 0x49, 0x52, 0x44, 0x10, 0x03, 0x42, 0x34, 0x5a, 0x32,
...
func file_desc_test_field_types_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_desc_test_field_types_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_desc_test_field_types_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_desc_test_field_types_proto_msgTypes[2].Exporter = func(v any, i int) any {
		...
		file_desc_test_field_types_proto_msgTypes[3].Exporter = func(v any, i int) any {
		...
		file_desc_test_field_types_proto_msgTypes[4].Exporter = func(v any, i int) any {
		...
		file_desc_test_field_types_proto_msgTypes[5].Exporter = func(v any, i int) any {
		...
		file_desc_test_field_types_proto_msgTypes[6].Exporter = func(v any, i int) any {
		...
		file_desc_test_field_types_proto_msgTypes[7].Exporter = func(v any, i int) any {
