...
var file_pkg_desc_test_pkg_proto_rawDesc = []byte{
	...
	0x08, 0x42, 0x3c, 0x5a, 0x3a, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f,
	...
	0x65, 0x73, 0x74, 0x64, 0x61, 0x74, 0x61, 0x2f, 0x70, 0x6b, 0x67, 0x3b, 0x70, 0x6b, 0x67,
}
...
func file_pkg_desc_test_pkg_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_pkg_desc_test_pkg_proto_msgTypes[0].Exporter = func(v any, i int) any {
			switch v := v.(*Bar); i {
			case 0:
				return &v.state
			case 1:
