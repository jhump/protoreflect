...
var file_desc_test_comments_proto_rawDesc = []byte{
	...
	0x7c, 0x20, 0x01, 0x28, 0x04, 0x52, 0x05, 0x67, 0x75, 0x69, 0x64, 0x32, 0x42, 0x36, 0x5a, 0x34,
...
func file_desc_test_comments_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_desc_test_comments_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_desc_test_comments_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_desc_test_comments_proto_msgTypes[2].Exporter = func(v any, i int) any {
