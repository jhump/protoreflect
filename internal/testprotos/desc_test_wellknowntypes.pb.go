...
var file_desc_test_wellknowntypes_proto_rawDesc = []byte{
	...
	0x36, 0x5a, 0x34, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x6a, 0x68,
...
func file_desc_test_wellknowntypes_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_desc_test_wellknowntypes_proto_msgTypes[0].Exporter = func(v any, i int) any {
