...
var file_desc_test2_proto_rawDesc = []byte{
	...
	0x75, 0x70, 0x78, 0x42, 0xab, 0x01, 0x0a, 0x31, 0x63, 0x6f, 0x6d, 0x2e, 0x67, 0x69, 0x74, 0x68,
	...
	0x65, 0x73, 0x74, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x73, 0x50, 0x01, 0x5a, 0x34, 0x67, 0x69, 0x74,
	...
	0x73, 0xa0, 0x01, 0x01, 0xf8, 0x01, 0x01, 0xaa, 0x02, 0x1d, 0x6a, 0x68, 0x75, 0x6d, 0x70, 0x2e,
	0x70, 0x72, 0x6f, 0x74, 0x6f, 0x72, 0x65, 0x66, 0x6c, 0x65, 0x63, 0x74, 0x2e, 0x74, 0x65, 0x73,
	0x74, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x73, 0xea, 0x02, 0x17, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x72,
	0x65, 0x66, 0x6c, 0x65, 0x63, 0x74, 0x2d, 0x74, 0x65, 0x73, 0x74, 0x70, 0x72, 0x6f, 0x74, 0x6f,
	0x73,
}
...
func file_desc_test2_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_desc_test2_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_desc_test2_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_desc_test2_proto_msgTypes[2].Exporter = func(v any, i int) any {
		...
		file_desc_test2_proto_msgTypes[3].Exporter = func(v any, i int) any {
			switch v := v.(*GroupX); i {
			case 0:
				return &v.state
			case 1:
