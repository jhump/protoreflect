...
func TestMessageRegistry_LookupTypes(t *testing.T) {
	...
	testutil.Eq(t, "https://foo.bar/google.protobuf.DescriptorProto", rr.URLForType(md))
	en, err := rr.FindEnumByURL("foo.bar/google.protobuf.FieldDescriptorProto.Type")
	testutil.Ok(t, err)
	testutil.Eq(t, ed, en)
	testutil.Eq(t, "https://foo.bar/google.protobuf.FieldDescriptorProto.Type", rr.URLForType(ed))
	...
	_, err = rr.FindEnumTypeByUrl("foo.bar/google.protobuf.DescriptorProto")
	_, ok = err.(*ErrUnexpectedType)
	testutil.Require(t, ok)
